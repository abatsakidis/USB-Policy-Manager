...
namespace USB_Policy
{
    public partial class frmPassword : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Passwords do not match, please retry","Error", MessageBoxButtons.OK,MessageBoxIcon.Error);
            ...
            if( Program.isPwdEnabled )
                ...
                {
                    MessageBox.Show("Wrong password, please retry", "Error",MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtOldPwd.Focus();
                    return;
                }
            ...
            {
                DisablePwd();
                MessageBox.Show("Password disabled", "Information",MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void StorePassword(string newPwdEncrypted)
        {
            try
            {
                ...
                StreamWriter fsPwdFile = new StreamWriter(new FileStream(Program.strPwdFilePath,FileMode.Create,FileAccess.Write));
